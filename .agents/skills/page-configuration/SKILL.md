...
**Important for AI Agents:** The exact schema and available keys in these JSON files may vary. **Always read the contents of the file in `src/config/` (e.g. `config.json`, `menu.json`) to discover what settings are currently available.**
