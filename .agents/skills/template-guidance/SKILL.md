...
description: Use this skill whenever you need to understand how the template works, including adding new pages, managing content, configuring pages, using components, understanding project architecture, using scripts, internationalization (i18n) or styling and theming. Use it for ANY question related to the structure, usage, and customization of the project template.
---
...
- **Internationalization (i18n), translations, and localization via next-intl:**
